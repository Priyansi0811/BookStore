<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddToCart.aspx.cs" Inherits="BookStore.AddToCart" %>
                                            ...
                                            <ItemTemplate>
                                                <div style="text-align: center; border: 1px solid #eee; padding: 15px; border-radius: 5px; background-color: white; width: 350px; box-shadow: 4px 4px 8px rgba(0, 0, 0, 0.2);">
                                                    ...
                                                    <h2 style="margin-bottom: 10px;">
                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("B_Title") %>' Font-Bold="True"></asp:Label>
                                                    </h2>
                                                    <br />
                                                    ...
                                                    <p style="text-align: left; margin-bottom: 20px;">
                                                        <asp:Label ID="Label6" runat="server" Text="ISBN : " Font-Bold="True" Font-Overline="False" Font-Size="Large"></asp:Label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("ISBN") %>'></asp:Label>
                                                    </p>
                                                    <p style="text-align: left; margin-bottom: 20px;">
                                                    ...
                                                    <p style="text-align: left; margin-bottom: 20px;">
                                                        <asp:Label ID="Label9" runat="server" Text="Quantity : " Font-Bold="True" Font-Overline="False" Font-Size="Large"></asp:Label>
                                                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("Quantity") %>' ></asp:Label>
                                                    </p>
                                                    <div style="display: flex; justify-content: space-around; margin-top: 10px;">
                                                        
                            <asp:LinkButton ID="btnIncrease" runat="server"  CommandName="Increase"  CommandArgument='<%# Eval("PId") %>'  Text="+" CausesValidation="false"  UseSubmitBehavior="false"  Style="padding: 8px 16px; text-decoration: none; background-color: #007bff; color: white; font-weight: bold; border: none; text-align: center;" ></asp:LinkButton>
                            
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            
                            <asp:LinkButton ID="btnDecrease" runat="server"  CommandName="Decrease"  CommandArgument='<%# Eval("PId") %>'  Text="-" CausesValidation="false"  UseSubmitBehavior="false"  Style="padding: 8px 16px; text-decoration: none;  background-color: #28a745; color: white; font-weight: bold; border: none; text-align: center;"></asp:LinkButton>
                                                        
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <br />
                                                        <asp:LinkButton ID="btnRemove" runat="server" CommandName="Remove" CommandArgument='<%# Eval("PId") %>'  CausesValidation="false"  UseSubmitBehavior="false"    Style="display: block; padding: 8px; width: 90%; text-decoration: none; border-radius: 5px; text-align: center; background-color: #dc3545; color: white; font-weight: bold; border: none; margin: 0 auto;" >Remove</asp:LinkButton>

                                                        <%--<asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("PId") %>' CommandName="cmd_chk" BackColor="#FFE4B5" BorderStyle="None" Font-Bold="True" Font-Italic="False" ForeColor="Black" Height="35px" Width="150px" Style="display: inline-block; text-decoration: none; line-height: 35px; text-align: center; border-radius: 18px; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);" OnClick="LinkButton1_Click">Checkout</asp:LinkButton>
                                                        <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("PId") %>' CommandName="cmd_cmd_remove_item" BackColor="Moccasin" BorderStyle="None" Font-Bold="True" Font-Italic="False" ForeColor="Black" Height="35px" Width="150px" Style="display: inline-block; text-decoration: none; line-height: 35px; text-align: center; border-radius: 18px; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);" OnClick="LinkButton2_Click">Remove Cart</asp:LinkButton>--%>
                                                    </div>
                                                </div>
                                            </ItemTemplate>
                                        </asp:DataList>
...
<%--                <asp:Button ID="btnCheckout" runat="server" Text="Proceed to Checkout" CssClass="btn btn-success" OnClick="btnCheckout_Click" />--%>
                ...
                <asp:Button ID="btnCheckout" BackColor="#44b89d" runat="server" Text="Proceed to Checkout" CssClass="btn btn-primary"  UseSubmitBehavior="false" OnClick="btnCheckout_Click"  />
