<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="BookStore.Registration" %>
              ...
              <input type="email" placeholder="Email" />
               ...
               <input type="password" placeholder="Password" />
                ...
                <input type="text" placeholder="Gender" />
                            ...
                            <asp:TextBox ID="TextBox4" runat="server" placeholder="Enter Gender"></asp:TextBox>
                  ...
                  <button>
                    SUBMIT
                            ...
                            <asp:Button ID="Button2" runat="server" Text="Submit" BackColor="#44b89d" OnClick="Button2_Click" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label18" runat="server" Text="If You Have Already an Acoount?" Font-Bold="False" Font-Italic="True" Font-Size="Medium"></asp:Label>
                            &nbsp;<asp:LinkButton ID="LinkButton3" href="login.aspx" runat="server" Font-Underline="True">Log In</asp:LinkButton>
            &nbsp;
                            <%--<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/index.html">Submit</asp:HyperLink>--%>

                            <%--<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="index.html" CssClass="btn btn-secondary w-100 py-3">Submit</asp:HyperLink>--%>
                        </div>
                        <div class="col-md-6">
                            <div class="img-box">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Password">
                                    <ItemTemplate>
                                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("Password") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="PhoneNo">
                                    <ItemTemplate>
                                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("PhoneNo") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="DateOfBirth">
                                    <ItemTemplate>
                                        <asp:Label ID="Label16" runat="server" Text='<%# Eval("DateOfBirth") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
