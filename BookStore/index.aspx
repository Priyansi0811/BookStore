<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="BookStore.index" %>
  ...
  <div class="hero_area">
    ...
    <a class="nav-link" href="Registration.aspx">Registration</a>
                  ...
                  <li class="nav-item active">
                      <a class="nav-link pl-lg-0" href="index.aspx">Home <span class="sr-only">(current)</span></a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    ...
                    <p>
                      It is very important for the customer to pay attention to the adipiscing process. He who wants to often leave the pain to the option.
                    </p>
                    <a href="">
                      Read More
                    </a>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              But no matter how much he is held to trouble, or to assume by rejecting him! Never to be rejected. Do they result in a blinded refusal to accept his pains and sufferings? For some of the present, a wise flexibility should be prepared, but here it will be a just pleasure! Just as they were to accept their lives, they left the guilt itself to be somewhat softened.
            </p>
            <a href="">
              Read More
            </a>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="box">
            ...
            <div class="detail-box">
              <h5>
                At least a little bit else I'm going to fly right
              </h5>
              <p>
