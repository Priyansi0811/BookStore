<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ALogin.aspx.cs" Inherits="BookStore.Admin.WebForm1" %>
      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Add_Book.aspx">Add Book</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Manage_order.aspx">Manage order</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="register.aspx">Registation</a>
                </li>--%>
      ...
      <div class="col-md-6 ">
        ...
        <%--<form action="#">
          ...
          <asp:Button ID="Button1" BackColor="#44b89d" runat="server" Text="Log In" OnClick="Button1_Click" />
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label1" runat="server" Text="If You Don't Have an Acoount" Font-Bold="False" Font-Italic="True" Font-Size="Medium"></asp:Label>
            ?&nbsp;
            <asp:LinkButton ID="LinkButton2" href="register.aspx" runat="server" Font-Underline="True">Register</asp:LinkButton>
            
          <%--<asp:LinkButton ID="LinkButton1" href="register.aspx" runat="server" Font-Underline="True">Register</asp:LinkButton>
          --%><%--<div>
