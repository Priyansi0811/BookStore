<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Manage_order.aspx.cs" Inherits="BookStore.Admin.Manage_order" %>
    ...
    <div class="row">
      <div class="col-md-6 ">
        ...
        <%--<form action="#">
          ...
          <asp:TextBox ID="TextBox1" placeholder="Delivery Date" runat="server"></asp:TextBox>
          <asp:TextBox ID="TextBox2" placeholder="Email Communication" runat="server"></asp:TextBox>
          <asp:TextBox ID="TextBox3" placeholder="Payment Method" runat="server"></asp:TextBox>
          <asp:Button ID="Button1" runat="server" Text="Done for Manage Order" BackColor="#44b89d" />
