<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Add_to_cart.aspx.cs" Inherits="BookStore.Add_to_cart" %>
     ...
     <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand" Style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; padding: 20px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff0f5;">
         <ItemTemplate>
             ...
             <%-- <asp:DataList ID="DataList1" runat="server" OnItemCommand="DataList1_ItemCommand">
                  <ItemTemplate>
                      <asp:Image ID="Image1" runat="server" Height="200px" Width="200px" ImageUrl='<%# "Admin/"+Eval("Image") %>' />
                      <br />
                      <br />
                      <asp:Label ID="Label1" runat="server" Text='<%# Eval("c_name") %>'></asp:Label>
                      <br />
                      ...
                      <br />
                      <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("Id") %>' CommandName="cmd_bn">Buy Now</asp:LinkButton>
          ...
          <%--<p><b>Book Title:</b>
              <asp:Label ID="lblBnm" runat="server"></asp:Label></p>
          <p><b>Author Name:</b>
              <asp:Label ID="lblAnm" runat="server"></asp:Label></p>
          <p><b>ISBN-13:</b>
              <asp:Label ID="lblIsbn" runat="server"></asp:Label></p>
          <p><b>Publication Date:</b>
              <asp:Label ID="lblPdate" runat="server"></asp:Label></p>
          <p><b>Number of Pages:</b>
              <asp:Label ID="lblPage" runat="server"></asp:Label></p>
          <p><b>Awards:</b>
              <asp:Label ID="lblAwrd" runat="server"></asp:Label></p>
          <p><b>Language:</b>
              <asp:Label ID="lblLan" runat="server"></asp:Label></p>
          <p><b>Category:</b>
              <asp:Label ID="lblCate" runat="server"></asp:Label></p>--%>
          ...
          <div>
              <asp:Label ID="Label3" runat="server" Text="ISBN-13"></asp:Label>
        ...
        <%--<form action="#">
          ...
          <asp:Button ID="Button1" BackColor="#44b89d" runat="server" Text="Log In" OnClick="Button1_Click" />
          <asp:LinkButton ID="LinkButton1" href="Registration.aspx" runat="server">Register</asp:LinkButton>--%>
          <%--<div>
