<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Display_Book.aspx.cs" Inherits="BookStore.Display_Book" %>
        ...
        <ItemTemplate>
            <div style="text-align: center; border: 1px solid #eee; padding: 15px; border-radius: 5px; background-color: white; width: 350px; box-shadow: 4px 4px 8px rgba(0, 0, 0, 0.2);">
                ...
                <h2 style="margin-bottom: 10px;">
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("B_Title") %>'></asp:Label>
                </h2>
                <br />
                ...
                <div style="display: flex; justify-content: space-around; margin-top: 10px;">
                    ...
                    <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("PId") %>' CommandName="cmd_atc" BackColor="#FFE4B5" BorderStyle="None" Font-Bold="True" Font-Italic="False" ForeColor="Black" Height="35px" Width="150px" Style="display: inline-block; text-decoration: none; line-height: 35px; text-align: center; border-radius: 18px; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);" OnClick="LinkButton2_Click">Add to Cart</asp:LinkButton>
                                ...
                                <asp:LinkButton ID="LinkButton3" runat="server" Height="45px" Width="150px" BackColor="#44B89D" Style="display: inline-block; text-decoration: none; line-height: 40px; text-align: center; border-radius: 10px;" CssClass="btn-box" ForeColor="White" Font-Size="Large">Previous</asp:LinkButton>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
                                <asp:LinkButton ID="LinkButton4" runat="server" Height="45px" Width="150px" BackColor="#44B89D" Style="display: inline-block; text-decoration: none; line-height: 40px; text-align: center; border-radius: 10px;" CssClass="btn-box" ForeColor="White" Font-Size="Large">Next</asp:LinkButton>
                                <br />
