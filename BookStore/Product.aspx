<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="BookStore.Product" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <a class="nav-link" href="login.aspx">Login</a>
                    ...
                    <a class="nav-link" href="Registration.aspx">Registration</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Product.aspx">Buy Product <span class="sr-only">(current)</span> </a>
                            </li>
                            <li class="nav-item">
            ...
            <%--<asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-control">
              ...
              <asp:ListItem>Express</asp:ListItem>
                            ...
                            <div class="form-group text-center">
                                <asp:Button ID="Button1" runat="server" Text="Save" BackColor="#44b89d" class="btn-box" OnClick="Button1_Click" />
                            </div>
                        </form>
                    </div>
                    <div class="col-md-6">
        ...
        <%--<table>
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="TextBox1" placeholder="Customer Name" runat="server" Width="500px"></asp:TextBox>
                          </td>
                      </tr>
                      ...
                      <tr>
                          <td>
                              <asp:TextBox ID="TextBox2" placeholder="Phone Number" runat="server"></asp:TextBox></td>
                      </tr>

                      <tr>
                          <td>
                              <asp:TextBox ID="TextBox3" class="message-box" placeholder="Address" runat="server"></asp:TextBox>
                          </td>
                      </tr>
                      ...
                      <tr>
                          <td>
                              <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal" Width="500px">
                                  <asp:ListItem>Fiction</asp:ListItem>
                                  <asp:ListItem>Non-fiction</asp:ListItem>
                                  <asp:ListItem>Science</asp:ListItem>
                                  <asp:ListItem>History</asp:ListItem>
                      ...
                      <tr>
                          <td>
                              <asp:TextBox ID="TextBox4" placeholder="Book Name" runat="server"></asp:TextBox></td>
                      </tr>
                      ...
                      <tr>
                          <td>
                              <asp:TextBox ID="TextBox5" placeholder="Quantity" runat="server"></asp:TextBox></td>
                      </tr>
                      ...
                      <tr>
                          <td>
                              <asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal" Width="500px">
                                  <asp:ListItem>Credit Card</asp:ListItem>
                                  <asp:ListItem>Debit Card</asp:ListItem>
                                  <asp:ListItem>Cash On Delivery</asp:ListItem>
                              </asp:RadioButtonList></td>
                      ...
                      <tr>
                          <td>
                              <asp:Button ID="Button1" class="btn-box" runat="server" Text="Save" /></td>
                      </tr>
                  </table>--%>
        <%--</div>--%>
